 ...
 * @author rcruz
 */
public class I_001_Kilos_Producidos_Hora_Hombre_Servlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (opcion.equals("ALL")) {
            sql = ConsultasBD.I_001_Kilos_Producidos_Hora_Hombre(mes, Integer.parseInt(anio));
        }
        else {
            sql = ConsultasBD.I_001_Kilos_Producidos_Hora_Hombre_Detalle(mes, Integer.parseInt(anio), opcion);
        }
