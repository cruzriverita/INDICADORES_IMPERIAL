 ...
 * @author rcruz
 */
public class I_002_Kg_Producidos_Kwh_Servlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String sql = "";
           ...
           sql = ConsultasBD_IndicadoresProduccion.I_002_Kg_Producidos_Kwh_General(mes, Integer.parseInt(anio),"<>");
          ...
          sql = ConsultasBD_IndicadoresProduccion.I_002_Kg_Producidos_Kwh_General(mes, Integer.parseInt(anio),"=");
           this.Generales(sql, ListaValores, Obj, responseObj, response);
            ...
            sql = ConsultasBD_IndicadoresProduccion.I_002_Kg_Producidos_Kwh_Planta(opcion, Integer.parseInt(anio));
            ...
            while (iterador.hasNext()) {
                ...
                //Integer Nplanta = (Integer) mapa.get("Mes");
                String Nplanta = Utilidades.MetodosGlobales.get_mes((Integer) mapa.get("Mes"));
