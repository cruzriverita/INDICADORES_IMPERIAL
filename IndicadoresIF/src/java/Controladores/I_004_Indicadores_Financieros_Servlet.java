...
public class I_004_Indicadores_Financieros_Servlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (opcion.equals("ALL")) {
            sql = Modelo_004_Indicadores_Financieros.Consulta_Financieros_General(Integer.parseInt(anio), mes, indicador);
            this.Generales(sql, ListaValores, Obj, responseObj, response);
        } else {
            sql = Modelo_004_Indicadores_Financieros.Consulta_Financieros_Detalle(Integer.parseInt(anio), indicador, opcion);
