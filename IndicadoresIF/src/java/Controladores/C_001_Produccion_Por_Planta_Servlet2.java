...
public class C_001_Produccion_Por_Planta_Servlet2 extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        while (iterador.hasNext()) {
            ...
            Cvalor8 = Utilidades.MetodosGlobales.redondear(Cvalor8, 2);
            Cvalor10 = Utilidades.MetodosGlobales.redondear(Cvalor10, 2);
            Cvalor12 = Utilidades.MetodosGlobales.redondear(Cvalor12, 2);
